<template>
    <div class="modelPop">
        ...
        <div class="modelPop-title"><span>{{ title2 }}</lspan><label>{{ pickeda }}</label></div>
        <ul class="modelPop-ui">
    ...
    export default {
        ...
        data() {
            return {
                ...
                pickedi: '过去24小时',
                listi: [
                    {name:'过去24小时',code:'pastMaxTemperature24'},
                    {name:'未来24小时',code:'futureMaxTemperature24'},
                    {name:'未来48小时',code:'futureMaxTemperature48'},
                    {name:'未来72小时',code:'futureMaxTemperature72'}
                ],
                title2: '最低温',
                pickeda: '',
                lista: [
                    {name:'过去24小时',code:'pastMinTemperature24'},
                    {name:'未来24小时',code:'futureMinTemperature24'},
                    {name:'未来48小时',code:'futureMinTemperature48'},
                    {name:'未来72小时',code:'futureMinTemperature72'}
                ]
            }
        },
        watch: {
        ...
        methods:{
        	close:function(){
        		this.$parent.list.temp.status=false;
        	},
            /**面板类型切换 */
