    ...
    export default {
        ...
        data() {
            return {
                ...
                picked: '未来24小时',
                list: [
                    {name:'过去1小时',code:'heavyRainfall'},
                    {name:'过去3小时',code:'heavyRainfall3'},
                    {name:'过去24小时',code:'heavyRainfall24'},
                    {name:'未来1小时',code:'heavyRainfall_qpf'},
                    {name:'未来3小时',code:'heavyRainfall3_qpf'},
                    {name:'未来6小时',code:'heavyRainfall6_2d'},
                    {name:'未来12小时',code:'heavyRainfall12_2d'},
                    {name:'未来24小时',code:'heavyRainfall24_2d'},
                    {name:'未来48小时',code:'heavyRainfall48_2d'},
                    {name:'未来48小时累计',code:'heavyRainfall48lj_2d'},
                    {name:'未来72小时累计',code:'heavyRainfall72lj_2d'}
                ]
            }
        },
        methods: {
        	 close:function(){
        	 	this.$parent.list.heavyRainfall.status = false;
	        },
            /**面板类型切换 */
