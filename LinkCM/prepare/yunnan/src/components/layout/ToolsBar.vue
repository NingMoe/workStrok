<template>
    <div class="program_one" v-if="program">  
        <div class="tools">
            <div class="top_tools">
                <ul>
    ...
    <div class="program_two" v-else>
        <div class="tools">
            <div class="top_tools">
                <ul>
                    <li v-for="item in list_two"  :class="[$key,{tooled:item.stat}]"></li>
                </ul>
            </div>
        </div>
    </div>
...
//--------------  下面的注释为暂时不需要的功能，后期开发需要 不删 -------------
                ...
                list_two:{
                   up: { title: '扩大', stat: false },
                   full: { title: '全屏', stat: false },  
                   down: { title: '缩小', stat: false }, 
                   global: { title: '全球', stat: false }, 
                   search:{title:'搜索',stat:false},
                   close:{title:'关闭',stat:false}
                },
                // list: {
                //    alter:{name: '修改',start:false},
                //    note:{name: '便签',start:false},
                //    sign:{name:'标记', stat: false },
                //    navigation:{name:'导航', stat: false },
                //    search:{name:'搜索', stat: false },
                //    video: { title: '视频回传', stat: false },
                //    tools_others: { title: '其他工具', stat: false }
                // },
                secondList: {
...
.program_two{
    .up::before{
        background: url("../../assets/img/contingency-plan/rightIcon.png") no-repeat -99px -60px;}
    .full::before{
        background: url("../../assets/img/contingency-plan/rightIcon.png") no-repeat -98px -38px;}
    .down::before{
        background: url("../../assets/img/contingency-plan/rightIcon.png") no-repeat -98px -17px;}
    .global::before{
        background: url("../../assets/img/contingency-plan/rightIcon.png") no-repeat -148px -0px;}
    .search::before{
        background: url("../../assets/img/contingency-plan/rightIcon.png") no-repeat 2px -55px;}
    .close::before{
        background: url("../../assets/img/contingency-plan/rightIcon.png") no-repeat -155px -60px;}
    .top_tools{
        li:hover{
            color: #fff;
        }
