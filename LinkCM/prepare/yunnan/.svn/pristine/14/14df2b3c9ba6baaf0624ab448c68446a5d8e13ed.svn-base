    ...
    <div class="town_tatble" v-el:town-table>
        ...
        <div class="export">
            <ul>
                <li>区（镇）列表导出模板：</li>
                <li>
                	<input id="town_all" class="packed form-radio" type="radio" value="all" v-model="picked"/>
                	<label for="town_all">镇名汇总</label>
                </li>
                <li>
                	<input id="town_single" class="packed form-radio" type="radio" value="single" v-model="picked"/>
                	<label for="town_single">镇名单行</label>
                </li>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            exportFile: function(){
                var url = this.dss+'/export/export!exportTownNameList.action';
        ...
        compiled: function(){
            var url = this.dss+'/gdmodel/model!getTownList.action';
