    ...
    export default {
        vuex: {
            getters: {
                ...
                params: state => state.townNameDropzone.params,
        ...
        watch: {
            fontSize: function() {
                this.updateParam('townNameDropzone', 'fontSize', this.fontSize);
            },
            streetName: function() {
                this.updateParam('townNameDropzone', 'fontStreet', this.streetName);
            },
            highlight: function(){
                this.updateParam('townNameDropzone','highlight',this.highlight);
            }
        },
        methods: {
            // 显示镇名列表
        ...
        ready: function() {
            this.updateParam('townNameDropzone', 'status', true);
        },
        detached: function() {
            this.btnMsg = '显示列表';
            this.updateParam('townNameDropzone', 'status', false);
        }
